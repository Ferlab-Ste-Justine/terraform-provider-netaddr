...
func resourceNetAddrAddressIpv4Create(d *schema.ResourceData, meta interface{}) error {
	return resourceNetAddrAddressCreate(d, meta, "ipv4", Ipv4StringToBytes, Ipv4BytesToString, IncAddressBy1, AddressGreaterThan)
}

func resourceNetAddrAddressIpv4Read(d *schema.ResourceData, meta interface{}) error {
	return resourceNetAddrAddressRead(d, meta, "ipv4", Ipv4BytesToString)
}

func resourceNetAddrAddressIpv4Delete(d *schema.ResourceData, meta interface{}) error {
	return resourceNetAddrAddressDelete(d, meta, Ipv4StringToBytes, Ipv4BytesToString, AddressLessThan)
}